...
BestHistory currently uses Supabase for account authentication and entitlement data, and Amazon SES for authentication email delivery. Those services process only the data required for account and email workflows, not the user's browsing history.
